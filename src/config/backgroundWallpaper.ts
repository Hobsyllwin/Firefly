...
export const backgroundWallpaper: BackgroundWallpaperConfig = {
	...
	src: {
		...
		desktop: [
			"assets/images/DesktopWallpaper/A2_1.png"
		],
		// 移动背景图片（支持单张或多张随机）
		// mobile: "assets/images/MobileWallpaper/m1.avif",
		mobile: [
			"assets/images/MobileWallpaper/A_25.jpg"
		],
		// 背景视频播放地址
		// 支持单个视频路径（字符串）或多个视频循环（数组）
		// 支持远程视频URL，本地视频请放在 public/assets/videos/ 目录下
		// playerUrl: "/assets/videos/firefly.mp4",
		playerUrl: "/assets/videos/Ark-loop.mp4",
	},
	// 横幅壁纸和全屏壁纸共享配置
	common: {
		...
		homeText: {
			...
			switchable: true,
			// 主页横幅主标题
			title: "The Engine Never Sleep.",
			// 主页横幅主标题字体大小
			titleSize: "3.8rem",
			// 主页横幅副标题
			subtitle: [
				"We Drift, Yet We Endure",
				"We Bleed, Yet We March",
				"We Burn, Yet We Shelter",
				"We Fall, Yet We Rise"
			],
			// 主页横幅副标题字体大小
			subtitleSize: "1.5rem",
